...
namespace QuanLyMyPham
{
    ...
    public class DataProvider
    {
        ...
        private void connect()
        {
            try
            {
                string strCnn = "Data Source=HOANDK;Initial Catalog=QuanLyMyPham;Integrated Security=True";
        ...
        //excute cau lenh insert, update, delete
        public bool executeNonQuery(string strSQL)
        {
            ...
            {
                Console.WriteLine("Insert/Update/delete error"+e.Message);
                return false;
            }
            return true;
        }
